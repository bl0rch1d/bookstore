describe Author, type: :model do
  ...
  context 'validations' do
    ...
    it { is_expected.to validate_length_of(:first_name).is_at_most(Author::FIRST_LAST_NAME_LENGTH) }
    it { is_expected.to validate_length_of(:last_name).is_at_most(Author::FIRST_LAST_NAME_LENGTH) }
